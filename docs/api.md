...
**成功响应**:
```json
{ "code": 200, "msg": "登录成功", "data": { "userId": 1, "mobile": "13800138000", "nickname": "测试用户" } }
```
...
**响应**:
```json
{ "code": 200, "data": { "userId": 1, "mobile": "13800138000", "nickname": "测试用户", "email": null } }
```
...
| 参数 | 类型 | 必填 | 说明 |
|------|------|------|------|
| file | File | 是 | 图片文件，仅支持 .png/.jpg/.jpeg，最大 5MB |
